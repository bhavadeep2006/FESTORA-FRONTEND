...
import { registeredTickets, userProfile } from '../data/mockData';
    ...
    <div className="tickets-page-view">
      <div className="section-container tickets-container">
        ...
        >
          <div>
            <span className="tickets-eyebrow">
              <Ticket size={14} /> MY DIGITAL PASSES ({registeredTickets.length})
            </span>
        ...
        <div className="tickets-grid-list">
          {registeredTickets.map((ticket, idx) => (
            <motion.div
              key={ticket.ticketId}
                ...
                <div className="modal-ticket-body">
                  ...
                  <div className="modal-info-grid">
                    <div className="modal-info-item">
                      ...
                      <span className="modal-info-val">{userProfile.name}</span>
                    </div>

                    <div className="modal-info-item">
                      <span className="modal-info-label">Registered College</span>
                      <span className="modal-info-val">{userProfile.college}</span>
                    </div>
